    ...
    public static void main(String[] args) {
        ...
        do {
			...
			case 1:
	            ...
	            NaveCarga naveCarga = new NaveCarga(nome, velocidadeMaxima, numeroTripulantes, combustivel, capacidadeCarga, capacidadeCarga);
			...
			case 2:
	           ...
	           NavePassageiros navePassageiros = new NavePassageiros(nome, velocidadeMaxima, numeroTripulantes, combustivel, numeroPassageiros, numeroPassageiros);
